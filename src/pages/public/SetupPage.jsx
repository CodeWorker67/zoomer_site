...
const stepsHapp = [
  ...
  'Откройте бот и нажмите "Подключить VPN"',
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Подключение Зумерский VPN: защищённая передача данных на Android, iOS, Windows и macOS." />
      </Helmet>
