...
const faqs = [
  ...
  },
  {
    ...
    a: 'Тариф PRO — до 5 устройств одновременно. Ускоритель игр Mobile — 1 устройство.',
  },
  {
    q: 'Как активировать бесплатный период?',
    a: 'Откройте раздел «Тарифы» и нажмите «Активировать бесплатно». Получите 1 день без оплаты и без привязки карты.',
  },
  {
